...
async def app_startup():
    ...
    # intialize the templates parser
    app.template_parser = TemplatesParser(language= app_settings.PRIMARY_LANGUAGE, default_language= app_settings.DEFAULT_LANGUAGE)
